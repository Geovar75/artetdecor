...
class getUx_LiveComponent_ComponentHydratorService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['ux.live_component.component_hydrator'] = new \Symfony\UX\LiveComponent\LiveComponentHydrator(new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['ux.live_component.doctrine_entity_property_hydrator'] ?? $container->load('getUx_LiveComponent_DoctrineEntityPropertyHydratorService'));
            yield 1 => ($container->privates['ux.live_component.serializer_property_hydrator'] ?? $container->load('getUx_LiveComponent_SerializerPropertyHydratorService'));
        }, 2), ($container->privates['property_accessor'] ?? $container->load('getPropertyAccessorService')), $container->getEnv('APP_SECRET'));
    }
}
