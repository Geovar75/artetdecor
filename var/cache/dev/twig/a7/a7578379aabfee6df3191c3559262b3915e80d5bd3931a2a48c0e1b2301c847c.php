...
class __TwigTemplate_9f129096492be3fd2a98145760f92a9e3dae7e098f681ba6ddcdf0ec6fda3290 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    <div class=\"row\" style=\"margin-top:200px; display:flex; flex-direction:column; justify-content:center;\">
        <div class=\"col-md-5\">
        ";
        // line 8
        echo $this->extensions['Symfony\Bridge\Twig\Extension\DumpExtension']->dump($this->env, $context, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 8, $this->source); })()));
        echo "
            <img src=\"assets/produts/assets/pictures/";
        // line 9
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 9, $this->source); })()), "image", [], "any", false, false, false, 9), "html", null, true);
        echo "\" alt=\"";
        ...
        echo "</h3>
            <p>";
        // line 13
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 13, $this->source); })()), "subtitles", [], "any", false, false, false, 13), "html", null, true);
        echo "</p>
            <span>";
        // line 14
        ...
        echo "</p>
            <a href=\"";
        // line 17
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("cart_add", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 17, $this->source); })()), "id", [], "any", false, false, false, 17)]), "html", null, true);
...
";
    ...
    {
        return array (  122 => 17,  118 => 16,  113 => 14,  109 => 13,  105 => 12,  97 => 9,  93 => 8,  89 => 6,  79 => 5,  59 => 3,  36 => 1,);
    }
...
{% block title %}Art et Décor | {{ product.name }}{% endblock %}

{% block content %}
    <div class=\"row\" style=\"margin-top:200px; display:flex; flex-direction:column; justify-content:center;\">
        <div class=\"col-md-5\">
        {{ dump(product)}}
            <img src=\"assets/produts/assets/pictures/{{ product.image }}\" alt=\"{{ product.name }}\" class=\"img-fluid\" style=\"max-height:200px; max-width:200px;\"/>
        </div>
        <div class=\"col-md-7 my-auto\">
            <h3>{{ product.name }}</h3>
            <p>{{ product.subtitles }}</p>
            <span>{{ (product.price / 100)|number_format(2, ',', '.') }} € HT</span>
            <hr>
...
{% endblock %}", "product/show.html.twig", "C:\\wamp64\\www\\artetdecor-master\\templates\\product\\show.html.twig");
    }
}
