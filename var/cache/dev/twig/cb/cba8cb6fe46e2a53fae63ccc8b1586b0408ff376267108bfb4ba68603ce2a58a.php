...
class __TwigTemplate_7582d36647944853da4c307ece10cc1452a685f6d3f44fa9841f9f891f37d35f extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        // line 6
        echo "<div style=\"margin: 200px 0 200px 0;\"></div>
    ";
        // line 7
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["results"]) || array_key_exists("results", $context) ? $context["results"] : (function () { throw new RuntimeError('Variable "results" does not exist.', 7, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["result"]) {
            // line 8
            echo "        ";
            echo $this->extensions['Symfony\Bridge\Twig\Extension\DumpExtension']->dump($this->env, $context, $context["result"]);
            echo "
    ";
        }
...
<div style=\"margin: 200px 0 200px 0;\"></div>
    {% for result in results %}
        {{ dump(result) }}
    {% endfor %}
{% endblock %}", "search/index.html.twig", "C:\\wamp64\\www\\artetdecor-master\\templates\\search\\index.html.twig");
    }
}
